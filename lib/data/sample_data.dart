...
class SampleData {
  ...
  static List<IncidentItem> getInitialIncidents() => [
    IncidentItem(
      id: 'inc-1',
      code: 'INC-2025-089',
      ...
      status: IncidentStatus.activeBreach,
      confidence: 98,
  ...
  static List<TechnicianJob> getInitialJobs() => [
    TechnicianJob(
      id: 'job-1',
      code: 'JOB-2025-041',
  ...
  static List<CameraItem> getInitialCameras() => [
    CameraItem(
      id: 'cam-1',
  ...
  static const List<EsgMetric> esgMetrics = [
    EsgMetric(
