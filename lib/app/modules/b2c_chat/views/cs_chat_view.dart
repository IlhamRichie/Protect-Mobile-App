...
class CsChatView extends GetView<CsChatController> {
                      ...
                      child: Obx(
                        () => ListView.builder(
                          ...
                          itemBuilder: (context, index) {
                            ...
                            return _buildChatBubble(context, msg, isMe, isTablet);
                          },
                        ),
                      ),
                    ),

                    // Interactive Free Survey Ticket Widget
                    _buildInteractiveTicketWidget(context),

                    // Input Bar
                    _buildInputBottomBar(context, isTablet),
                  ],
                ),
              ),
            );
  ...
  Widget _buildChatBubble(BuildContext context, dynamic msg, bool isMe, bool isTablet) {
    final double maxBubbleWidth = isTablet ? 480.0 : MediaQuery.of(context).size.width * 0.75;
  ...
  Widget _buildInteractiveTicketWidget(BuildContext context) {
    return Obx(() {
  ...
  Widget _buildInputBottomBar(BuildContext context, bool isTablet) {
    return Container(
      padding: EdgeInsets.symmetric(
