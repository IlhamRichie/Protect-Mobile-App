...
class OnboardingView extends GetView<OnboardingController> {
          ...
          builder: (context, constraints) {
            ...
            return Center(
              child: ConstrainedBox(
                ...
                child: Column(
                  children: [
                    // Top Bar with Logo & Skip Pill Button
                    _buildTopBar(horizontalPadding),

                    // Main PageView Area
                    Expanded(
                      child: _buildPageView(horizontalPadding),
                    ),

                    // Bottom Action Bar (Indicators & Next/Start CTA)
  ...
  Widget _buildPageView(double horizontalPadding) {
